            ...
            children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        TextButton(
                          ...
                          child: const Text('Read X Block Of Y Sector'),
                        ),
                        TextButton(
                          style: ButtonStyle(
                            foregroundColor:
                          ...
                          child: const Text('Read X Sector'),
                        ),
                        TextButton(
                          style: ButtonStyle(
                            foregroundColor:
                        ...
                        TextButton(
                          ...
                          onPressed: () async => showToast(
                              message: (await NfcClassicMifare.blockCount)
                                  .toString()),
                          child: const Text('Get Block Count'),
                        ),
                        TextButton(
                          style: ButtonStyle(
                            foregroundColor:
                          ...
                          onPressed: () async => showToast(
                              message: (await NfcClassicMifare.sectorCount)
                                  .toString()),
                          child: const Text('Get Sector Count'),
                        ),
                      ],
                    ),
                    Container(
                    ...
                    TextButton(
                      ...
                      child: const Text('Write X Block'),
                    ),
                    TextButton(
                      style: ButtonStyle(
                      ...
                      child: const Text('Write X Block (Raw)'),
                    ),
                    TextButton(
                      style: ButtonStyle(
                        foregroundColor: MaterialStateProperty.all(Colors.teal),
              ...
              Visibility(
                ...
                child: TextButton(
                  ...
                  child: const Text('Read Card Information'),
                ),
              )
            ],
          ),
